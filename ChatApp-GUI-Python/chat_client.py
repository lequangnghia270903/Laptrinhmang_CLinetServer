...
class FirstScreen(tk.Tk):
    def __init__(self):
        ...
        background_image = Image.open("images/login_bg_ca.jpg")
        background = background_image.thumbnail((550, 400))
        background = ImageTk.PhotoImage(background_image)

        upload_image = Image.open('images/upload_ca.png')
        upload = upload_image.thumbnail((25, 25))
        upload = ImageTk.PhotoImage(upload_image)
        ...
        upload_button = tk.Button(self.first_frame, image=upload, compound="left", text="Upload Image",
    ...
    def process_data(self):
        if self.username_entry.get():
            ...
            try:
                client_socket.connect(("127.0.0.1", 17064))
